...
$authenticationKey = $_ENV['AUTHENTICATION_KEY']; // Replace with your actual authentication key
$uploadDirectory = $_ENV['UPLOAD_DIRECTORY']; // Replace with the directory where files will be uploaded
$domainUrl = $_ENV['DOMAIN_URL']; // Replace with your domain URL
$stringLength = $_ENV['STRING_LENGTH']; // Replace with the desired length of the random string
